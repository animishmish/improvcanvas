...
// GUI
	...
	f2.add(sliders, 'saturation', 0, 3).name('Saturation').onChange(onParamsChange);

	f2.add(sliders, 'brightness', 0, 5).name('Brightness').onChange(onParamsChange);

	f2.add(sliders, 'invert', 0, 1).name('Invert').onChange(onParamsChange);
